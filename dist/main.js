...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"displayBoard\": () => (/* binding */ displayBoard)\n/* harmony export */ });\n/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ \"./src/game.js\");\n\n\nfunction displayBoard(board, container, mode) {\n    \n\n    container.innerHTML = '';\n    for (let y = 0; y < 10; y++) {\n        for (let x = 0; x < 10; x++) {\n            const content = board.get(x, y);\n            const square = document.createElement('div');\n            square.classList.add('square');\n            if (content == 'm') {\n                square.classList.add('missed');\n            } else if (content == 'x') {\n                square.classList.add('hit');\n            } else if (content != 'e') {\n                square.classList.add('ship');\n            }\n            container.appendChild(square);\n            if (mode == 'computer') {\n                square.addEventListener('click', () => {\n                    if (!_game__WEBPACK_IMPORTED_MODULE_0__.gameInProgress) {\n                        return;\n                    }\n                    if (content == 'x' || content == 'm') {\n                        return;\n                    }\n                    board.receiveAttack(x, y);\n                    displayBoard(board, container, mode);\n                    _game__WEBPACK_IMPORTED_MODULE_0__.playTurn();\n                });\n            }\n\n        }\n    }\n}\n\n//# sourceURL=webpack://battleship/./src/gameDOM.js?");
